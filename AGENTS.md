...
- **Before starting a task:** read this file and `STATUS.md` in full. Don't assume — if the task is ambiguous, state your interpretation in `STATUS.md` before writing code, don't just guess and proceed silently.
