  ...
  const packages = [
    {
      ...
      name: 'Landing Page',
      slug: 'landing-page',
      description: 'A single high-converting page for a launch or campaign. Focused, fast, and built around one clear action.',
      price: '2500.00',
      estimatedDuration: '2–3 weeks',
      sortOrder: 1,
      translations: {
        de: { name: 'Landing Page', description: 'Eine einzelne, conversion-starke Seite für einen Launch oder eine Kampagne. Fokussiert, schnell und auf eine klare Aktion ausgerichtet.' },
        sq: { name: 'Faqe Uljeje', description: 'Një faqe e vetme me konvertim të lartë për një lançim ose fushatë. E fokusuar, e shpejtë dhe e ndërtuar rreth një veprimi të qartë.' },
      },
    },
    {
      id: 'pkg-full-website',
      name: 'Full Website',
      slug: 'full-website',
      description: 'A complete multi-page marketing site. Structured for growth, content, and credibility.',
      price: '6500.00',
      estimatedDuration: '6–8 weeks',
      sortOrder: 2,
      translations: {
        de: { name: 'Komplette Website', description: 'Eine vollständige Marketing-Website mit mehreren Seiten. Aufgebaut für Wachstum, Inhalte und Glaubwürdigkeit.' },
        sq: { name: 'Faqe e Plotë', description: 'Një faqe marketingu e plotë me shumë nënfaqe. E strukturuar për rritje, përmbajtje dhe besueshmëri.' },
      },
    },
    {
      id: 'pkg-web-app',
      name: 'Web App Build',
      slug: 'web-app-build',
      description: 'A custom web application, scoped individually. Designed around your product and your users.',
      price: '18000.00',
      estimatedDuration: '10–14 weeks',
      sortOrder: 3,
      translations: {
        de: { name: 'Web-App-Entwicklung', description: 'Eine individuelle Web-Anwendung, einzeln abgestimmt. Rund um dein Produkt und deine Nutzer gestaltet.' },
        sq: { name: 'Ndërtim Web App-i', description: 'Një aplikacion web i personalizuar, i përcaktuar veç e veç. E dizajnuar rreth produktit dhe përdoruesve të tu.' },
      },
    },
  ];
