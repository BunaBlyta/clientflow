...
Last updated: 2026-08-27 by Claude Code — notes composer padding fix (see below); earlier: composer auto-compact fix + copy message (folding in Codex's concurrent notification/translation work below)
