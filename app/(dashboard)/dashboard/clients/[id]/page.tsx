  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="mt-1 text-[13px] text-muted-foreground">{t("project.clientSince", { date: formatDate(client.createdAt, locale) })}</p>
      </div>
